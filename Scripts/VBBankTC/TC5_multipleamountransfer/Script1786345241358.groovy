...
for (int i=1; i<=data.getRowNumbers(); i++) {
	...
	String amount= data.getValue('amount', i)	
	

WebUI.setText(findTestObject('Object Repository/transferfromanotheruser/txt_enteraccountno'), fullname)

WebUI.waitForElementClickable(findTestObject('Object Repository/transferfromanotheruser/searchresultaccont'), 10)
WebUI.click(findTestObject('Object Repository/transferfromanotheruser/searchresultaccont'))

//enter amount
WebUI.setText(findTestObject('Object Repository/transferfromanotheruser/txt_amount'), amount)

//description

WebUI.setText(findTestObject('Object Repository/transferfromanotheruser/txt_description'), amount +'USD transfer to '+ fullname)

//click on TransferMoney
WebUI.click(findTestObject('Object Repository/transferfromanotheruser/bt_transferMoney'))

KeywordUtil.logInfo(amount + "USD Transfer successfully to " + fullname)
